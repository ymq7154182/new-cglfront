<template>
    <div class="login-wrap">
        <div class="ms-login">
            <div class="ms-title">北京市中关村中学食堂配菜系统</div>
                    ...
                    if (valid) {
                        ...
                        this.$axios.get(url).then((res) => {
                            if (res.data.errmsg === '登录成功!') {
                                ...
                                // localStorage.setItem('ms_period', res.data.period);
                                // localStorag.setItem('ms_schoolyear', res.data.schoolyear);
                                this.$router.push('/');
                            }
                            else {
...
<style scoped>
    .login-wrap{
        ...
        width:100%;
        height:100%;
        background-image: url(../../assets/1234444.jpg);
        background-size: 100%;
    }
    .ms-title{
        width:100%;
