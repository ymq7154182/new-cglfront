                ...
                <el-scrollbar style="height: 100%" class="scrollbar">
                    ...
                    <div class="infoword" v-if="flag2 === 1">
                        ...
                        <div style="margin-top: 10px">
                            ...
                            <div style="margin-bottom: 10px">
                                <el-tag v-for="(item, index) in textareaThulacSegment" :key="index"  :disable-transitions="false" size="mini" style="margin-left: 5px;margin-top: 10px" :color="color3"><span style="font-size: 16px;color: white">{{item}}</span></el-tag>
                            </div>
                        </div>
                    </div>
                </el-scrollbar>
