    ...
    <div>
        <div class="back">
            ...
            <div class="somecircle2">
                <span class="word2">jieba分词器</span>
            </div>
            <div class="somecircle3 somecircle31" @click="sentenceProcess">
                <span class="word1">jieba</span>
            </div>
            <div class="sometext">
                    ...
                    <div class="infoword" v-if="flag2 === 1">
                        ...
                        <div style="margin-top: 10px">
                            ...
                            <div style="margin-bottom: 10px">
                                <el-tag v-for="(item, index) in textareasentenceProcess" :key="index"  :disable-transitions="false" size="mini" style="margin-left: 5px;margin-top: 10px" :color="color1"><span style="font-size: 16px;color: white">{{item}}</span></el-tag>
                            </div>
                        </div>
                    </div>
                </el-scrollbar>
